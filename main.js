var cuentas = [
    { nombre: "Mali", saldo: 200, password: 'privada' },
    { nombre: "Gera", saldo: 290, password: '321413' },
                ...
                if (result.isConfirmed) {
                    ...
                    if (reglaTotales < 10) {
                        Swal.fire({
                            icon: 'warning',
                            title:'Aviso',
                            text: 'No puedes tener menos de $10.00 en tu cuenta',
                        })
                    } else {
                        globalTotal = saldoActual -= saldoIngresado
